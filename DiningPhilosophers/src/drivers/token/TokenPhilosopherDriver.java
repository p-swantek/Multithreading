...
public class TokenPhilosopherDriver {
	...
	public static void main(String[] args) {
        ...
        final Comparable fork4 = new Integer(4);//"Fork 4";
     	...
     	//if there are N philosophers, only give out N-1 permits so not all sit at the table
		int numPhilosophers = 4; 
		Semaphore s = new Semaphore(numPhilosophers-1); 
		
		// factory to create philosophers that utilize tokens to gain access to the table

...
/*
 * Implementation of an OptimisticMutableList, uses an atomic reference to an ImmutableList along with compareAndSet to ensure
 * thread safety on list operations without using any locking
 */
class OptimisticMutableListImpl implements OptimisticMutableList{
	...
	public OptimisticMutableListImpl(){
		immutableRef = new AtomicReference<ImmutableList>(ImmutableList.empty); //construct an atomic reference to an empty ImmutableList
	}

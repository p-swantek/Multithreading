...
/**
 * An ordered collection of elements. This is a cut down version of the Java
 * collections library, intended for teaching purposes.
 * 
 * @author Alan Jeffrey
 * @version 1.0.4
...
public interface MutableList {
     ...
     * @exception NoSuchElementException thrown if the element is not in the
     *                list.
     */

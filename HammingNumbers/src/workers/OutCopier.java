...
public class OutCopier implements Runnable {
    ...
    // number of channels to output copied data to
    private static final int NUM_OUTPUT_CHANNELS = 4;
    ...
    private final List<Channel> outputChannels = new ArrayList<>(NUM_OUTPUT_CHANNELS);

...
public class WorkerFactory {
     ...
     * 
     * @param multiple
     *            the multiplier for this worker to use
     * @param input
     *            the input channel of this worker
     * @param output
     *            the output channel of this worker
     ...
     * 
     * @param input2
     *            input channel from a multiplication worker
     * @param input3
     *            input channel from a multiplication worker
     * @param input5
     *            input channel from a multiplication worker
     * @param output
     *            output channel to write the merged result
     ...
     * 
     * @param in
     *            input channel from the merger
     * @param out2
     *            output channel to a multiplication worker
     * @param out3
     *            output channel to a multiplication worker
     * @param out5
     *            output channel to a multiplication worker
     * @param outP
     *            output channel to a printer thread
     * @param seed
     *            the initial value to use to initialize this copier
